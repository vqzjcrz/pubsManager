namespace pubsManager
{
    partial class Form1
    {
        ...
        private void InitializeComponent()
        {
            ...
            splitContainer1.Size = new Size(1094, 563);
            ...
            label8.Font = new Font("Arial", 26.25F, FontStyle.Underline, GraphicsUnit.Point, 0);
            label8.ForeColor = SystemColors.Control;
            label8.Location = new Point(0, 0);
            label8.Name = "label8";
            label8.Padding = new Padding(20, 20, 0, 0);
            label8.Size = new Size(748, 72);
            label8.TabIndex = 0;
            label8.Text = "Forms";
            // 
            // checkBox8
            ...
            label2.TabIndex = 2;
            label2.Text = "Last, First, MI : ";
            label2.Click += label2_Click;
            // 
            // comboBox1
            // 
            comboBox1.AutoCompleteCustomSource.AddRange(new string[] { "Profile1, Profile2, Profile3" });
            ...
            label1.Font = new Font("Arial", 26.25F, FontStyle.Underline, GraphicsUnit.Point, 0);
            label1.ForeColor = SystemColors.Control;
            label1.Location = new Point(0, 0);
            label1.Name = "label1";
            label1.Padding = new Padding(0, 20, 0, 0);
            label1.Size = new Size(341, 72);
            label1.TabIndex = 0;
